...
def _sensor_mode_from_config(sequence_config: dict) -> str:
    """Derive a human-readable sensor mode label from the sequence config."""
    node_order = sequence_config.get("node_order", [])
    num_nodes = len(node_order)
    if num_nodes == 5:
        return "5node-json"
    return f"{num_nodes}node-json"
    ...
    def predict_json(self, request: PredictJsonRequest) -> Dict[str, Any]:
        ...
        return {
            ...
            "data": {
                ...
                "window_size": None,
                "step_size": None,
                "sensor_mode": _sensor_mode_from_config(self.checkpoint.get("sequence_config", {})),
...
def health() -> Dict[str, Any]:
    ...
    return {
        ...
        "sensor_mode": _sensor_mode_from_config(active_service.checkpoint.get("sequence_config", {})) if active_service is not None else "unknown",
        "version": "2.0.0",
        "robustness_gates": {
            "confidence_threshold": CONFIDENCE_THRESHOLD,
            "top_margin_threshold": TOP_MARGIN_THRESHOLD,
    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                "window_size": None,
                "step_size": None,
                "sensor_mode": _sensor_mode_from_config(active_service.checkpoint.get("sequence_config", {})),
