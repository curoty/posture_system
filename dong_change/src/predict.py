...
def _check_node_completeness(
    ...
    Args:
        ...
        min_complete_ratio: Minimum fraction of frames that must contain
            ...
            non-zero data.
        expected_nodes: Set of expected JSONL node names. Defaults to the
            9-node set for backward compatibility.
...
def predict_record(
    ...
    from src.jsonl_sequence_dataset import resolve_node_mapping as _resolve_mapping
    expected_nodes = set(_resolve_mapping(sequence_config.node_order).keys())
