...
# Comprehensive mirror pairs covering both 9-node and 5-node configurations.
# ``_build_mirror_index`` iterates over node_order, so extra entries here are
# harmless — they are only applied when both nodes exist in the order.
_MIRROR_PAIRS = {
    # 9-node
    "l_elbow": "r_elbow", "r_elbow": "l_elbow",
    "l_wrist": "r_wrist", "r_wrist": "l_wrist",
    "l_knee": "r_knee", "r_knee": "l_knee",
    "l_skate": "r_skate", "r_skate": "l_skate",
    "head": "head",
    # 5-node
