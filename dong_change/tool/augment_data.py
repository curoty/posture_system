...
# 5-node required set (waist + knees + ankles)
REQUIRED_NODES_5NODE: Tuple[str, ...] = (
    "waist",
    "left_knee",
    "right_knee",
    "left_ankle",
...
# 左右镜像对（5-node: waist + knees + ankles）
MIRROR_PAIRS_5NODE: Dict[str, str] = {
    "left_knee": "right_knee",
    "right_knee": "left_knee",
